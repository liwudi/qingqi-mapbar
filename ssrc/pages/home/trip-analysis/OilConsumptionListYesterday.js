...
import {queryYesterdayAvgOilWear, queryYesterdayAvgOilWearRanking} from '../../../services/TripService';
export default class OilConsumptionListYesterday extends Component {
    constructor(props) {
        super(props);
        this.avgData = null;
        this.listData = null;
    ...
    fetchAvg() {
        return queryYesterdayAvgOilWear()
            .then(((data)=>{
                this.avgData = data;
                this.fetchList();
            }))
    ...
    fetchList() {
        return queryYesterdayAvgOilWearRanking()
            .then(((data)=>{
                this.setState({
    ...
    renderAvg() {
        ...
        return <View style={[estyle.fxCenter, estyle.marginBottom, estyle.cardBackgroundColor, estyle.paddingVertical]}>
                    ...
                    <Text style ={[estyle.text]}>您昨日的平均油耗</Text>
