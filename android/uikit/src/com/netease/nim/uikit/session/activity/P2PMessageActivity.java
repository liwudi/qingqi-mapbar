...
import com.netease.nim.uikit.EntypoFonts.MyEntypoIcon;
...
//        setTitle(UserInfoHelper.getUserTitleName(sessionId, SessionTypeEnum.P2P));
    ...
    protected int getContentViewId() {
        return R.layout.nim_message_activity_add;
    }
...
//        setToolBar(R.id.toolbar, options);
        TextView  message_back = (TextView) findViewById(R.id.message_back);
        IconDrawable drawable=  new IconDrawable(this, MyEntypoIcon.chevron_thin_left);
        drawable.color(Color.WHITE);
        message_back.setBackground(drawable);
